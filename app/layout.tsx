...
export const metadata = {
  ...
  description: "Maritime, mining, logistics and business training — book, learn, and get certified.",
};
        ...
        <footer className="mt-20 bg-abyss py-10 text-sm text-slate-400">
          <div className="mx-auto max-w-6xl px-5">
            ...
            <p className="mt-2 max-w-xl">
              Maritime, mining, logistics, business and technical training · Est. 2012 &amp; 2017.
              Delivered online, in-classroom, and on site.
            </p>
            <p className="mt-4">
